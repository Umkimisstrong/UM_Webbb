...
<script type="text/javascript">
	...
	//    - 매개변수
	//      ㆍurl      : (String) POST 함수로 연결하는 서버 측 URL
	//      ㆍdata     : (Object) 이름과 값의 쌍으로 프로퍼티를 가진 객체.
	//                   미리 구성 및 인코딩 된 쿼리 스트링
	//      ㆍcallBack : (Function) 요청이 완료되면 호출되는 함수.
	...
	$(function()
	{
		$("#sendButton").click(function()
		{
			...
			//check~!!
			/* 
			$.post("PostTest01_ok.jsp", {su1:su1, su2:su2, oper:oper},  function(args)
			{
				$("result").html(args);
			}); */
			...
			//$.Post("PostTest01_ok.jsp", {su1:su1}, function(args){$("result").html(args)})
	        //$.post("요청URL", {이름:값}, function(넘겨받은값){$("선택자").html(넘겨받은값)})
